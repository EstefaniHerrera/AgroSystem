...
@section('contenido')
    ...
    <form id="form_guardar" name="form_guardar" method="POST"
        action="{{ route('pedidosProveedor.update', ['id' => $pedido->id]) }}" onsubmit="confirmar()">
        @csrf
    ...
    <div class="modal fade" id="agreagar_detalleP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('detalle_pedidosProveedor.crear2', ['DetalleCompra' => $pedido->id]) }}"
                    method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editar_detalleP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('detalle_pedidosProveedor.editar2', ['DetalleCompra' => $pedido->id]) }}"
                    method="POST">
                    @csrf
                    <div class="modal-header">
...
@section('js')
    @push('alertas')
        <script>
            $('#Proveedor').val({{ $pedido->EmpresaProveedora }});
        </script>
        <script>
