...
<form id="form_guardarC" name="form_guardarC" method="POST" action="{{ route('gasto.guardar') }}" onsubmit="confirmar()">
    ...
    <div class="form-group">
        ...
        {{--#69 Corrección del maxlength de 200 a 150--}}maxlength="150" minlength="5" required cols="30" rows="6">{{ old('descripcion') }}</textarea>
    </div>
    ...
    <div class="form-group">
        ...
        placeholder="Total del gasto" value="{{ old('total') }}" required step="any" min="1" max="50000" 
        {{--#68 Corrección colocación de maxlength--}}
        minlength="1" maxlength="7" oninput="maxlengthNumber(this);">
    </div>
