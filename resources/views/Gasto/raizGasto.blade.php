        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="GET" action="{{ route('gasto.reporte') }}">
                    <div class="form-row">
                        ...
                        <div class="col-sm-2 my-1">
                            ...
                            <input style="width: 100%" type="date" class="form-control" name="FechaDesde" id="Fechadesde"
                                ...
                                {{--#71 Corrección colocación de minimo--}}
                    ...
                    <br>
                    <input type="submit" class="btn" style="background-color:gray; border-color:black; color:white"
                        value="Buscar">
                    <a href="{{ route('gasto.index') }}" class="btn my-8"
...
@section('contenido')
    ...
    <div class="d-grid gap-2 d-md-block">
        <a class="btn" style="background-color:rgb(65, 145, 126); border-color:black; color:white"
            href="{{ route('gasto.crear') }}"> <span class="glyphicon glyphicon-plus"></span>Agregar gasto </a>
        <a class="btn" style="background-color:rgb(65, 145, 126); border-color:black; color:white"
            href="{{ route('gasto.pdf', [
                'anio1' => $fechadesde,
                'anio2' => $fechahasta,
                'empleado' => $empleado,
                'tipo' => $TipoG,
            ]) }}"><span
                class="glyphicon glyphicon-print"></span> Imprimir reporte </a>
    </div>
    <br>
        ...
        <tbody>
            @forelse ($gastos as $gast)
                <tr class="active">
                    ...
                    <td scope="row">{{ $gast->person->NombresDelEmpleado }} {{ $gast->person->ApellidosDelEmpleado }}
                    </td>
                    ...
                    <td>
                        <a class="btn" style="background-color:white; border-color:black; color:black"
                            href="{{ route('gasto.update', ['id' => $gast->id]) }}"> <span
                                class="glyphicon glyphicon-eye-open">
                            </span>
                            Más detalles
                        </a>
                        <a class="btn" style="background-color:white; border-color:black; color:black"
                            href="{{ route('gasto.edit', ['id' => $gast->id]) }}">
