...
<div id="detalles">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td scope="col">
                    {{ \Carbon\Carbon::parse($venta->FechaVenta)->locale('es')->isoFormat('DD MMMM, YYYY') }}
                </td>
            </tr>
    ...
    <a class="btn" style="background-color:gray; border-color:black; color:white" href="{{ route('ventas.index') }}">
        <span class="glyphicon glyphicon-arrow-left"></span>
        Regresar </a>
    <button type="button" class="btn" style="background-color:rgb(65, 145, 126); border-color:black; color:white" onclick="imprimir()">
        <span class="glyphicon glyphicon-file"></span>
        Imprimir cotización</button>
</div>
...
<div id="imprimir" style="display: none">
    ...
    <p style="float: left">Fecha {{ date_format($venta->created_at, 'd') }} de {{ $mes }} del
        {{ date_format($venta->created_at, 'Y') }}
    </p>
