...
<form id="form_guardarC" name="form_guardarC" method="POST" action="{{ route('cliente.guardar4') }}" onsubmit="confirmar()">
    @csrf
    ...
    <a class="btn btn-info" href="{{route('pedidosClienteP.crear')}}">Cerrar</a>
