...
<form id="form_guardarC" name="form_guardarC" method="POST" action="{{ route('cliente.guardar2') }}" onsubmit="confirmar()">
    @csrf
    ...
    <div class="form-group">
        ...
        placeholder="Lugar de Procedencia" maxlength="70" value="{{old('LugarDeProcedencia')}}" required>
    </div>

    <br>
    <input type="submit" class="btn btn-primary" value="Guardar">
    <input type="reset" class="btn btn-danger" value="Limpiar">
    <a class="btn btn-info" href="{{route('ventas.crear', ['clientepedido' => 0])}}">Cerrar</a>
