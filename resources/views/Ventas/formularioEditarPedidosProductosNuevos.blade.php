...
@section('contenido')
    ...
    <form id="form_guardarP" name="form_guardarP" method="POST"
        action="{{ route('pedidosClienteP.update', ['id' => $pedido->id]) }}" onsubmit="confirmar()">
        @csrf
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input style="width: 100%" type="number" class="form-control" name="TotalAnticipo" id="TotalAnticipo"
                        required maxlength="10" value="{{ old('TotalAnticipo', $pedido->TotalAnticipo) }}" min="0"
                        max="9999" title="Ingrese el total del anticipo en números, sin decimales." pattern="[0-9]+">
                </div>
            </div>
    ...
    <div class="modal fade" id="agreagar_detalleP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('detalle_pedidosClienteP.crear2', ['DetalleCompra' => $pedido->id]) }}"
                    method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editar_detalleP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('detalle_pedidosClienteP.editar2', ['DetalleCompra' => $pedido->id]) }}"
                    method="POST">
                    @csrf
                    <div class="modal-header">
