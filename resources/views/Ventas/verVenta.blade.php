...
@section('contenido')
    ...
    @endif
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="col">{{ $venta->personals->NombresDelEmpleado }}
                        {{ $venta->personals->ApellidosDelEmpleado }}</td>
                </tr>
                <tr>
                    <th scope="row">Fecha de venta</th>
                    <td scope="col">
                        {{ \Carbon\Carbon::parse($venta->FechaVenta)->locale('es')->isoFormat('DD MMMM, YYYY') }} </td>
                </tr>
        ...
        <a class="btn" href="{{ route('ventas.index') }}"
    ...
    <div id="imprimir" style="display: none">
        ...
        <H2>FACTURA: {{ substr(str_repeat(0, 10) . $venta->NumFactura, -10) }}</H2>
        <?php
        $mes = '';
        ...
        @else
            ...
            <br><br>
            <p>Dirección {{ $venta->clientes->LugarDeProcedencia }}</p>
        @endif
