...
@section('contenido')
    ...
    <form id="form_guardar" name="form_guardar" method="POST"
        action="{{ route('pedidosClientes.update', ['id' => $pedido->id]) }}" onsubmit="confirmar()">
        @csrf
    ...
    <div class="modal fade" id="editar_detalle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('detalle_pedidosCliente.editar2', ['DetalleCompra' => $pedido->id]) }}"
                    method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar detalles</h5>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input style="width: 100%" type="number" name="Cantidad"
                                        ...
                                        min="1" title="Ingrese cantidad de la compra en números." maxlength="4"
                                        pattern="[0-9]+">
                                </div>
                            </div>
                        </div>
