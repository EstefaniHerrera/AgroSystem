...
class DetalleVentaController extends Controller
{
    ...
    { 
        ...
        if ($existe) {
            ...
            $detalles = DetalleVenta::findOrFail($request->input('IdDetalle'));

            $invent =  Inventario::where('IdProducto', '=', $detalles->IdProducto)
            ->where('IdPresentacion', '=', $detalles->IdPresentacion)->firstOrFail();

            $invent->Existencia = $invent->Existencia + $detalles->Cantidad;
